...
import {shouldReverseRtlScroll} from "react-scrollbars-custom/dist/types/util";
import AvaBorder from "components/AvaBorder";
...
const AvatarBorderFinal:React.FC<PropsType> = ({colors, setToggle, toggle}) => {
...
export default AvatarBorderFinal;