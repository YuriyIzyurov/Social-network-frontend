...
const AvatarEffect = ({id, colors}: {id:string, colors:string[]} ) => {
    switch (id) {
        ...
        case 'Polygon2':
            return <svg width="167" height="168" viewBox="0 0 167 168" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Polygon 1_2" opacity="0.857143" d="M22.6259 18.9102L113.049 1.73263C117.057 0.971311 121.089 2.9271 122.975 6.54632L164.69 86.6231C166.529 90.1528 165.905 94.4634 163.142 97.3265L98.4446 164.356C95.681 167.219 91.3969 167.993 87.807 166.278L6.363 127.362C2.682 125.603 0.587627 121.638 1.20824 117.605L15.2111 26.5922C15.807 22.7188 18.7775 19.6412 22.6259 18.9102Z" stroke="url(#paint0_linear_1_13)" stroke-width="1.5"/>
                <defs>
        ...
        case 'Polygon4':
            return <svg width="166" height="167" viewBox="0 0 166 167" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Polygon 1_5" opacity="0.642857" d="M1.23854 109.53L17.6267 18.9221C18.3531 14.9062 21.624 11.8402 25.6772 11.3757L115.357 1.09923C119.31 0.64626 123.109 2.77286 124.79 6.37965L164.145 90.8181C165.826 94.4249 165.013 98.7035 162.125 101.442L96.6111 163.57C93.6501 166.378 89.2 166.914 85.6584 164.889L5.7489 119.208C2.34798 117.263 0.541061 113.387 1.23854 109.53Z" stroke="url(#paint0_linear_1_11)" stroke-width="1.5"/>
                <defs>
        ...
        case 'Polygon5':
            return <svg width="168" height="166" viewBox="0 0 168 166" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Polygon 1_6" opacity="0.571429" d="M21.3386 146.675L1.02118 56.8611C0.120702 52.8805 1.93344 48.7799 5.4828 46.7685L84.0138 2.26606C87.4754 0.30445 91.803 0.777676 94.7596 3.44108L163.975 65.7939C166.931 68.4573 167.854 72.714 166.266 76.3633L130.238 159.155C128.61 162.897 124.723 165.129 120.672 164.649L29.2712 153.821C25.3812 153.36 22.2033 150.497 21.3386 146.675Z" stroke="url(#paint0_linear_1_10)" stroke-width="1.5"/>
                <defs>
        ...
        case 'Polygon6':
            return <svg width="164" height="167" viewBox="0 0 164 167" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Polygon 1_7" opacity="0.5" d="M57.1099 161.875L3.31696 87.148C0.932826 83.836 0.999564 79.3533 3.48125 76.115L58.3895 4.46588C60.8098 1.30769 64.9786 0.0521081 68.7409 1.34822L156.82 31.6914C160.582 32.9875 163.095 36.5448 163.059 40.5243L162.237 130.806C162.2 134.887 159.494 138.46 155.578 139.602L67.2045 165.353C63.4433 166.449 59.3993 165.055 57.1099 161.875Z" stroke="url(#paint0_linear_1_9)" stroke-width="1.5"/>
                <defs>
        ...
        case 'Polygon7':
            return <svg width="171" height="163" viewBox="0 0 171 163" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="Polygon 1_8" opacity="0.428571" d="M84.0014 160.522L5.29746 112.768C1.80925 110.651 0.119983 106.499 1.13979 102.548L23.7032 15.1337C24.6978 11.2806 28.0451 8.49525 32.0147 8.21754L124.947 1.71585C128.916 1.43813 132.619 3.73033 134.139 7.40743L168.643 90.8292C170.202 94.5996 169.107 98.9466 165.947 101.528L94.6521 159.777C91.6178 162.256 87.351 162.555 84.0014 160.522Z" stroke="url(#paint0_linear_1_8)" stroke-width="1.5"/>
                <defs>
